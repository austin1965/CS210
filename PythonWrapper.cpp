...
// Code in this section is code provided by the instructor, refactored into a class for readability.
 ...
 * Return: None
 */
void PythonWrapper::CallProcedure(string pName) {
 ...
 */
int PythonWrapper::callIntFunc(string proc, string param) {
 ...
 */
int PythonWrapper::callIntFunc(string proc, int param) {
	char* procname = new char[proc.length() + 1];
	std::strcpy(procname, proc.c_str());
